...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(name) => "Для ${name} уже установлена последняя версия";

  static String m7(name) => "${name} обновлено";

  static String m8(name) => "Обновление ${name}...";

  static String m9(count) =>
      "${Intl.plural(count, one: '${count} час назад', few: '${count} часа назад', many: '${count} часов назад', other: '${count} часа назад')}";

  static String m10(target) => "${target} является недопустимой политикой";

  static String m11(proxyName) => "${proxyName} является недопустимым прокси";

  static String m12(providerName) =>
      "${providerName} является недопустимым провайдером прокси";

  static String m13(subRule) => "${subRule} является недопустимым подправилом";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "desc": MessageLookupByLibrary.simpleMessage(
      "Современный кроссплатформенный прокси-клиент с простым и удобным интерфейсом.",
    ),
    ...
    "invalidPolicy": m10,
    "invalidProxy": m11,
    "invalidProxyProvider": m12,
    "invalidSubRule": m13,
    "invite": MessageLookupByLibrary.simpleMessage("Мои приглашения"),
    ...
    "orders": MessageLookupByLibrary.simpleMessage("Мои заказы"),
    ...
    "termsOfServiceDesc": MessageLookupByLibrary.simpleMessage(
      "Продолжая использовать этот сервис, вы подтверждаете, что прочитали, поняли и согласны с данными условиями. Вы должны соблюдать применимые законы и правила и не использовать сервис для незаконной деятельности. Данные условия могут время от времени обновляться; руководствуйтесь последней официальной версией.",
    ),
    ...
    "users": MessageLookupByLibrary.simpleMessage("Пользователь"),
    ...
    "wallet": MessageLookupByLibrary.simpleMessage("Мой кошелек"),
