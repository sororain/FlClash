...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(name) => "${name} はすでに最新です";

  static String m7(name) => "${name} 更新済み";

  static String m8(name) => "${name}を更新中...";

  static String m9(count) => "${count}時間前";

  static String m10(target) => "${target} は無効なポリシーです";

  static String m11(proxyName) => "${proxyName} は無効なプロキシです";

  static String m12(providerName) => "${providerName} は無効なプロキシプロバイダーです";

  static String m13(subRule) => "${subRule} は無効なSUB_RULEです";
  ...
  static String m21(label) => "${label}はURLである必要があります";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "termsOfServiceDesc": MessageLookupByLibrary.simpleMessage(
      "本サービスを継続してご利用いただくことで、本利用規約を読み、理解し、同意したものとみなします。適用される法令を遵守し、本サービスを違法行為に使用してはなりません。本利用規約は予告なく更新される場合があります。最新の公式版をご参照ください。",
    ),
