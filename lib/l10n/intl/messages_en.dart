...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(name) => "${name} is already up to date";

  static String m7(name) => "${name} updated";

  static String m8(name) => "Updating ${name}...";

  static String m9(count) =>
      "${Intl.plural(count, one: '1 hour ago', other: '${count} hours ago')}";

  static String m10(target) => "${target} is an invalid policy";

  static String m11(proxyName) => "${proxyName} is an invalid proxy";

  static String m12(providerName) =>
      "${providerName} is an invalid proxy provider";

  static String m13(subRule) => "${subRule} is an invalid SUB_RULE";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "invalidSubRule": m13,
    "invite": MessageLookupByLibrary.simpleMessage("My Invites"),
    ...
    "termsOfServiceDesc": MessageLookupByLibrary.simpleMessage(
      "By continuing to use this service, you acknowledge that you have read, understood, and agree to these terms. You must comply with applicable laws and regulations and shall not use this service for any illegal activities. These terms may be updated from time to time; please refer to the latest official version.",
    ),
