...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(name) => "${name} 已是最新版本";

  static String m7(name) => "${name} 已更新";

  static String m8(name) => "正在更新 ${name}...";

  static String m9(count) => "${count} 小时前";

  static String m10(target) => "${target} 是一个无效的策略";

  static String m11(proxyName) => "${proxyName} 是一个无效的代理";

  static String m12(providerName) => "${providerName} 是一个无效的代理集";

  static String m13(subRule) => "${subRule} 是一个无效的SUB_RULE";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "invalidSubRule": m13,
    "invite": MessageLookupByLibrary.simpleMessage("我的邀请"),
    ...
    "termsOfServiceDesc": MessageLookupByLibrary.simpleMessage(
      "继续使用本服务即表示您已阅读、理解并同意本服务条款。您应遵守适用的法律法规，不得利用本服务从事任何违法违规活动。本服务条款可能不定期更新，请以官方发布的最新版本为准。",
    ),
    ...
    "wallet": MessageLookupByLibrary.simpleMessage("我的钱包"),
