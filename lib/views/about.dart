...
import 'package:sororain/iqoo/services/update_service.dart';
import 'package:sororain/iqoo/help/update_helper.dart';
    ...
    return generateSection(
      ...
      items: [
        ...
        ListItem(
          ...
          onTap: () {
            // 固定链接,不再从面板 /user/comm/config 动态获取
            globalState.openUrl('https://t.me/sororain');
          },
