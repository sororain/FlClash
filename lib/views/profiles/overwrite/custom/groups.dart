...
import 'package:sororain/models/models.dart' hide FileInfo;
import 'package:sororain/providers/providers.dart';
import 'package:sororain/state.dart';
import 'package:sororain/views/profiles/overwrite/custom/proxy_providers.dart';
            ...
            return DecorationListItem(
              ...
              leading: SizedBox.square(
                ...
                child: IconTheme.merge(
                  ...
                  child: CommonTargetIcon(src: proxyGroup.icon ?? '', size: 32),
                ),
              ),
              title: TooltipText(
                text: Text(
