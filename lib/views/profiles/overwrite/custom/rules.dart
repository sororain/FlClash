...
import 'package:sororain/common/input_limits.dart';
import 'package:sororain/enum/enum.dart';
import 'package:sororain/features/overwrite/rule.dart';
import 'package:sororain/models/clash_config.dart';
import 'package:sororain/models/state.dart';
import 'package:sororain/providers/providers.dart';
import 'package:sororain/state.dart';
import 'package:sororain/views/profiles/overwrite/custom/widgets.dart';
...
class _AddOrEditRuleViewState extends ConsumerState<_AddOrEditRuleView> {
  ...
  Widget build(BuildContext context) {
    ...
    final height = isBottomSheet
        ...
        : double.maxFinite;
    return AdaptiveSheetScaffold(
      actions: [IconButton(icon: const Icon(Icons.check), onPressed: _handleSave)],
      type: SheetProvider.of(context)?.type ?? SheetType.page,
      body: Container(
