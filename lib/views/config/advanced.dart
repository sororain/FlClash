...
import 'package:sororain/views/config/dns.dart';
import 'package:sororain/views/config/network.dart';
import 'package:sororain/views/config/on_demand.dart';
import 'package:sororain/views/config/scripts.dart';
import 'package:sororain/widgets/list.dart';
import 'rules.dart';
import 'package:sororain/widgets/scaffold.dart';
  ...
  Widget build(BuildContext context) {
    final List<Widget> items = [
      ...
      ListItem.open(
        ...
        leading: Icon(Icons.rocket, fontWeight: FontWeight.w900),
