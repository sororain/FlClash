...
/// helper 只接受 `\\.\pipe\SororainCore_<32 位小写 hex>` 形状的 Core 地址
/// （见 services/helper/src/service/hub.rs 的 is_allowed_core_address），
/// 所以后缀必须是 32 位 hex，不能是短随机数。
...
const repository = 'sororain/FlClash';
