...
import 'package:sororain/common/color.dart';
import 'package:sororain/providers/action.dart';
import 'package:sororain/state.dart';
import 'package:sororain/widgets/activate_box.dart';
        ...
        children: [
          ...
          Container(
            ...
            child: IconButton(
              ...
              iconSize: 32.0,
              onPressed: globalState.container.read(profilesActionProvider.notifier).addProfileFormQrCode,
